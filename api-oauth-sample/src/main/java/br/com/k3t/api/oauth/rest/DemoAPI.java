...
public interface DemoAPI {
	...
	@Operation(summary = "Diz olá!", tags = DemoAPI.DEMO_API_TAG)
	@ApiResponses(value = {
	...
	@Operation(summary = "Diz olá para uma pessoa autenticada!", tags = DemoAPI.DEMO_API_TAG)
	@ApiResponses(value = {
	...
	ResponseEntity<MessageResponse> sayProtectedHello(Authentication auth);
}
